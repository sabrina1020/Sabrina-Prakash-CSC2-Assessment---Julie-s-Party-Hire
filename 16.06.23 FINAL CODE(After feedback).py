...
root.geometry("800x650")  # Starting size for the window
...
def save_details():
    ...
    try:
        ...
        elif not receipt_number.isdigit():
            messagebox.showerror("Invalid Input", "Please enter a receipt number, not letters.")
        else:
